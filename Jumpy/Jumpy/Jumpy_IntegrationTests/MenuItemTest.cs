...
namespace Jumpy_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(DaWeng.Jumpy.GuidList.guidJumpyCmdSet, (int)DaWeng.Jumpy.PkgCmdIDList.cmdidJumpy);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Jumpy", "DaWeng.Jumpy.JumpyPackage");
