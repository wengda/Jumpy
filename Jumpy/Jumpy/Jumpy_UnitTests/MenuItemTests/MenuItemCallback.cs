...
namespace Jumpy_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new JumpyPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(DaWeng.Jumpy.GuidList.guidJumpyCmdSet, (int)DaWeng.Jumpy.PkgCmdIDList.cmdidJumpy);
